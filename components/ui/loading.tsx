...
const LoadingPage = (error: string, actionButton: boolean, butonText: string = '') => {
    ...
    return (
        <div className='gap-5 w-full h-[100vh] grid grid-cols-1'>
            <div className='flex-wrap m-auto my-auto content-center bg-white w-1/2 p-10 rounded-xl'>
                <div className='flex flex-col gap-5 items-center justify-center '>
                    <p className='font-bold text-center text-white text-3xl text-background'>{error}</p>
